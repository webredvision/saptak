...
const FeedbackTheme2 = () => {
  ...
  return (
    <div>
      ...
      <div className="px-4 bg-[var(--rv-bg-black)] text-[var(--rv-white)]">
        <div className="relative main-section flex items-center justify-center">
          <div className="relative bg-[var(--rv-bg-secondary)] border border-[var(--rv-white-light)] p-6 rounded-xl shadow-lg w-full max-w-xl flex flex-col gap-3">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full border   border-[var(--rv-white-light)]] bg-transparent rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-[var(--rv-bg-primary)] focus:border-[var(--rv-bg-primary)]"
              ...
              <div className="text-right">
                <Button type={'submit'} text={'Submit Feedback'} Icon={FaArrowRight} />
              </div>
            </form>
          </div>

          {showModal && (
            <div className="fixed inset-0 bg-black/40 backdrop-blur-sm bg-opacity-40 flex items-center justify-center z-50 p-2">
              <div className="bg-[var(--rv-bg-black)] rounded-lg shadow-lg p-5 w-full max-w-md relative border border-[var(--rv-white-light)]">
                <button
                ...
                <div className="mt-5 flex items-center justify-center">
                  <Button onClick={handleClose} type={'submit'} text={'Close'} Icon={FaArrowRight} />
                </div>
              </div>
            </div>
          )}
