    ...
    <div>
      ...
      <div className="px-4 bg-[var(--rv-bg-white)] text-[var(--rv-white)]">
        <div className="relative main-section flex items-center justify-center">
          <div className="relative bg-[var(--rv-bg-secondary)] border border-[var(--rv-border)] p-6 rounded-xl shadow-lg w-full max-w-xl flex flex-col gap-3 overflow-hidden md:p-6  justify-center z-10 ">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-6">
                    {["Yes", "No"].map((val) => (
                      ...
                      >
                        ...
                        />
                        <span
                          className="w-5 h-5 rounded-full border-2 border-[var(--rv-border)] flex items-center justify-center transition-all duration-200 peer-checked:bg-[var(--rv-primary)]"
                        >
              ...
              <div className="flex flex-col gap-3">
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full border   border-[var(--rv-border)] bg-transparent rounded-lg p-2 outline-none"
              ...
              <div className="text-right">
                <button
                  type="submit"
                  className="bg-[var(--rv-bg-primary)] text-[var(--rv-white)] px-4 py-2 rounded-lg shadow-md hover:bg-[var(--rv-bg-primary-dark)] transition duration-200"
                >
                  Submit Feedback
                </button>
              </div>
            ...
            <div className="fixed inset-0 bg-black/40 bg-opacity-40 flex items-center justify-center z-50 p-2">
              <div className="bg-[var(--rv-bg-white)] rounded-lg shadow-lg p-5 w-full max-w-md relative border border-[var(--rv-primary-light)]">
                ...
                <div className="mt-5 text-center">
                  <button
                    onClick={handleClose}
                    className="bg-[var(--rv-primary)] text-[var(--rv-white)] px-4 py-2 rounded-lg hover:bg-[var(--rv-secondary)] transition"
                  >
                    Close
                  </button>
                </div>
