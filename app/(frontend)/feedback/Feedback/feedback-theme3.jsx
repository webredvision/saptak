    ...
    <div>
      ...
      <div className="px-4">
        <div className="relative main-section flex items-center justify-center">
          ...
          <div className="relative bg-[var(--rv-bg-primary-light)] p-6 rounded-xl shadow-lg w-full max-w-xl flex flex-col gap-3 border border-[var(--rv-primary)]">
