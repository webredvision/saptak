...
const AboutTheme5 = ({ teamData, aboutData, otherData, statsData, amcLogosData }) => {
  const items = [
    {
      heading: "Mission",
        ...
        <div className="max-w-7xl mx-auto main-section flex flex-col gap-10 md:gap-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-8 items-center">
            <div className='flex flex-col gap-4 items-start md:col-span-2'>
              ...
              <Button link={'/contact-us'} text="Read More" Icon={FaLongArrowAltRight} />
            </div>
          ...
          <div className="flex flex-col gap-5 md:gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8">
              {items.map((item, index) => (
                <div
                  key={index}
                  className="border backdrop-blur-sm rounded-xl shadow-md p-5 md:p-8 flex flex-col gap-2 items-center text-center hover:shadow-lg transition-all duration-300"
                >
                  <div>
                    <div className="w-20 h-20 bg-[var(--rv-bg-secondary)] p-3 rounded-xl">
                      <Image
                        ...
                        width={400}
                        height={400}
                        className="object-contain w-full h-full mx-auto brightness-0 invert filter"
                      />
                    </div>
                  </div>
