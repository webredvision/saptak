        ...
        <div className="inline-flex border border-[var(--rv-white-light)] rounded-full shadow-inner bg-[var(--rv-bg-white-light)]">
          {tabs.map((tab, index) => (
            <Link
              ...
              className={`px-5 md:px-14 py-2 text-lg font-medium border border-[var(--rv-white-light)] hover:bg-[var(--rv-secondary)] hover:text-[var(--rv-black)] transition-all duration-300 ${getRoundedClass(index)} ${
                activeTab === tab.key
