...
import { SwpPerformanceChart } from "@/app/components/charts/swpPerformanceChart";
import SwpPerformanceTable from "@/app/components/swpPerformanceTable";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export default function Page() {
  ...
  const handleSubmit = async () => {
    if (
      ...
      try {
        const response = await axios.post(
          `${process.env.NEXT_PUBLIC_NEXTAUTH_URL}/api/research-calculator/swp-performance`,
          {
  ...
  return (
    <div className={styles.contactPage}>
      <InnerPage title={"SWP Performance"} />
      <div className="px-4">
          ...
          <div className="max-w-screen-xl mx-auto">
            <div className="mb-5">
              <CalculatorHeader
                ...
                subtitle=""
                activeCalculator="SWP Performance"
                items={performance}
              />
            </div>
            <Toaster />
                    ...
                    <div className="">
                      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 my-10">
                        ...
                        <div className="py-2 px-1 border border-[var(--rv-primary)] shadow-sm rounded-lg text-center bg-[var(--rv-bg-white)]">
                          ...
                          <h6 className="font-medium  text-sm">
                            {result?.totalWithdrawlAmount}
                          </h6>
                        </div>
                        <div className="py-2 px-1 border border-[var(--rv-primary)] shadow-sm rounded-lg text-center bg-[var(--rv-bg-white)]">
                          <p className="font-semibold text-xs whitespace-nowrap">
                            Remaning Fund Value (B)
                          </p>
                          <h6 className="font-medium  text-sm">
                            {result?.fundRemaining}
                          </h6>
                        </div>
                        <div className="py-2 px-1 border border-[var(--rv-primary)] shadow-sm rounded-lg text-center bg-[var(--rv-bg-white)]">
                          <p className="font-semibold text-xs whitespace-nowrap">
