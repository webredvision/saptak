        ...
        <div className="">
            ...
            <div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-5 mb-5">
                {Array.from({ length: 5 }).map((_, index) => (
                    <div
                        key={index}
                        className="px-3 py-3 bg-[var(--rv-bg-white)] border border-[var(--rv-gray)] rounded shadow flex flex-col items-center"
                    >
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-1 grid-cols-1 gap-5">
                ...
                <div className="col-span-3">
                    ...
                    <div className="overflow-hidden border border-[var(--rv-gray)] rounded">
                        <Skeleton className="w-full h-8 bg-[var(--rv-bg-gray-light)]" />
                        {Array.from({ length: 10 }).map((_, index) => (
