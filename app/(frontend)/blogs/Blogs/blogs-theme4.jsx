          ...
          >
            ...
            {!loading &&
              filteredBlogs?.map((article, index) => (
                <div
                  key={index}
                  className="group bg-[var(--rv-bg-white)] border grid grid-cols-1 rounded-xl overflow-hidden transition-all duration-300"
                >
