...
const SkeletonCard = () => {
  return (
    <div className="bg-[var(--rv-bg-gray-light)] animate-pulse rounded-xl overflow-hidden h-60 w-full">
          ...
          >
            ...
            {!loading &&
              filteredBlogs?.map((article, index) => (
                <div
                  key={index}
                  className="group bg-[var(--rv-bg-white)] border rounded-xl overflow-hidden transition-all duration-300"
                >
                  ...
                  <div className="p-6 flex flex-col justify-between gap-3 col-span-2">
                    <h6 className="line-clamp-2 font-bold leading-snug group-hover:text-[var(--rv-primary)] transition-colors">
                      {article?.metatitle}
                    </h6>
