...
const BlogsTheme2 = ({ blogs }) => {
  ...
  return (
    <div>
      ...
      <div className="bg-[var(--rv-bg-black)] px-4 text-[var(--rv-white)]">
        <div className="max-w-7xl mx-auto main-section flex flex-col items-center gap-5 md:gap-8">
          ...
          <div className="flex items-center justify-between gap-5 w-full">
            ...
            <div>
              <select
                className="p-1 rounded-md border px-2 outline-none md:px-5 border-[var(--rv-black)] text-[var(--rv-black)]"
          ...
          <motion.div
            ...
            className="grid md:grid-cols-2 grid-cols-1 gap-6 w-full"
          >
            {loading &&
            ...
            {!loading &&
              filteredBlogs?.map((article, index) => (
                <div
                  key={index}
                  className="group bg-[var(--rv-bg-secondary)] md:h-60 grid grid-cols-1 md:grid-cols-3 rounded-xl overflow-hidden transition-all duration-300"
                >
                  ...
                  <div className="p-6 flex flex-col justify-between gap-3 col-span-2">
                    ...
                    <p className="text-[var(--rv-white)] flex-grow line-clamp-2">
                      {article?.description}
                    </p>
