                ...
                <div className="main-section border-b">
                    <div className="max-w-7xl mx-auto flex flex-col gap-6 md:gap-10">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-10 gap-4">
                                {services?.map((service) => {
                                    ...
                                    return (
                                        <Link
                                            ...
                                            className="relative">
                                            <div className="relative border border-[var(--rv-primary)] z-10   text-[var(--rv-white)] rounded-xl overflow-hidden p-5 md:p-8 flex flex-col items-center justify-center text-center gap-5 bg-gradient-to-tl from-[var(--rv-bg-secondary)] via-[var(--rv-bg-secondary)] to-[var(--rv-bg-primary)]">
