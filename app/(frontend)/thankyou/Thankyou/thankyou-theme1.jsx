...
const ThankyouTheme1 = ({ message = "Thank you for your submission!", subMessage = "We appreciate your interest and will get back to you shortly." }) => {
    return (
        <>
            ...
            <section className="bg-[var(--rv-bg-white)] px-4">
                <div className="main-section flex items-center justify-center ">
                    ...
                    >
                        ...
                        >
                            <Button text={'Go Back Home'} link={'/'} className={'hover:bg-[var(--rv-bg-secondary)] py-3 text-[var(--rv-white)] font-semibold shadow-md bg-[var(--rv-bg-primary)] transition-all'} Icon={FaArrowRight} />
                        </motion.div>
                    </motion.div>
                </div>
            </section>
