...
const CommissionDisclosurePage = () => {
    return (
        <div className={``}>
            <InnerPage title={"Commission Disclosure"} />
            <div className="px-4">
                <div className="max-w-screen-xl mx-auto main-section">
                    <h2 className=" font-bold text-[var(--primary)] mb-2 mt-2">Commission Disclosure under SEBI Circular SEBI/IMD/CIR No.4 /168230/09</h2>
