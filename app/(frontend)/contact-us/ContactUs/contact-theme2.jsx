...
const ContactTheme2 = ({ sitedata }) => {
  ...
  return (
    <div>
      ...
      <ToastContainer />
      <div className="bg-[var(--rv-bg-secondary)] text-[var(--rv-white)]">
        <div className="w-full overflow-hidden">
          <div className="w-full h-[70vh] p-2 border   border-[var(--rv-white-light)]">
            <iframe
              src={sitedata?.iframe}
              width="100%"
              height="100%"
        ...
        <div className="px-4">
          <div className="max-w-7xl mx-auto main-section flex flex-col gap-5 md:gap-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              <div className="bg-[var(--rv-bg-black)] rounded-xl p-4 flex gap-4 flex-col border border-[var(--rv-white-light)]">
            ...
            <form
              ...
              className="bg-[var(--rv-bg-black)] border   border-[var(--rv-white-light)] rounded-xl shadow-sm p-4 md:p-7 flex flex-col gap-2"
            >
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border rounded-lgb-4   border-[var(--rv-white-light)] outline-none bg-transparent"
                required
              />
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="4"
                className="w-full px-4 py-3 border rounded-lgb-4   border-[var(--rv-white-light)] outline-none bg-transparent resize-none"
                required
              ></textarea>
