...
const ContactTheme4 = ({ sitedata }) => {
  ...
  return (
    <div>
      ...
      <ToastContainer />
      <div className="bg-[var(--rv-bg-white)] text-[var(--rv-black)]">
        <div className="px-4">
          <div className="max-w-7xl mx-auto main-section flex flex-col gap-5 md:gap-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              <div className="bg-[var(--rv-bg-white)] rounded-xl p-4 flex gap-4 flex-col border border-[var(--rv-border)]">
                <div className="w-12 h-12 rounded-xl bg-[var(--rv-bg-primary)] text-[var(--rv-white)] flex items-center justify-center">
                  <FaMailBulk size={20} />
                </div>
                <div>
                  <p>Email</p>
            ...
            <form
              ...
              className="bg-[var(--rv-bg-white)] border   border-[var(--rv-border)] rounded-xl shadow-sm p-4 md:p-7 flex flex-col gap-2"
            >


              <Heading align="start" title={'Get in Touch'} heading={'Let’s Chat, Reach Out to Us'} description={'Have questions? Send us a message and we’ll reply soon.'} />
              <div className="grid md:grid-cols-2 gap-4 my-4">
                <input
                  ...
                  className="w-full px-4 py-3 border rounded-lg   border-[var(--rv-border)] outline-none bg-transparent"
                  required
                />
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border rounded-lg mb-4   border-[var(--rv-border)] outline-none bg-transparent"
                required
              />
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="4"
                className="w-full px-4 py-3 border rounded-lg mb-4   border-[var(--rv-border)] outline-none bg-transparent resize-none"
                required
              ></textarea>
              ...
              <div>
                <CaptchaRow
                  ...
                  inputClassName="border-[var(--rv-border)] bg-transparent text-[var(--rv-black)]"
              ...
              <div className="mt-2">
                <Button
                  type={"submit"}
                  disabled={loading}
                  className={` border border-[var(--rv-border)]
        ...
        <div className="w-full overflow-hidden">
          <div className="w-full h-[70vh] p-2 border   border-[var(--rv-border)]">
            <iframe
              src={sitedata?.iframe}
              width="100%"
              height="100%"
