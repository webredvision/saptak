        ...
        <div className="max-w-7xl mx-auto main-section">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div className="flex flex-col gap-4">
              ...
              <ul className="mt-2 space-y-2 pl-5 text-[var(--rv-primary)] font-bold list-disc">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-2 flex justify-end">
                      <Button
                        ...
                        className={`flex items-center gap-2 bg-[var(--rv-bg-white)] text-[var(--rv-primary)] hover:bg-[var(--rv-secondary)] hover:text-[var(--rv-white)] ${
                      ...
                      {goalQuestions[selectedValue].map((q) => (
                        <div key={q.id} className="space-y-1">
                          ...
                          <input
                            ...
                            className="w-full rounded-lg px-3 py-2 text-[var(--rv-primary)] outline-none border border-[var(--rv-white)] focus:border-[var(--rv-secondary)]"
                          />
                        </div>
                      ))}
                    </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="mt-4 flex gap-3 justify-end">
                  <Button
                    ...
                    className={`bg-[var(--rv-bg-gray-light)] text-[var(--rv-gray-dark)] hover:bg-[var(--rv-bg-gray)] ${
...
export default GoalQuestionsTheme1;
