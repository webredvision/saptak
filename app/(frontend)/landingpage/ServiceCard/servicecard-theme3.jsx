...
const ServicecardTheme3 = ({ services }) => (
    <section className="w-full bg-[var(--rv-bg-white)] px-4 text-[var(--rv-black)] overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col gap-5 main-section-top">
            <div className="flex md:flex-row flex-col items-center justify-between gap-5">
                <div className="md:w-1/2">
                    <Heading align="start" title={'Our Services'} heading={'Comprehensive Financial Solutions'} description={'Explore our range of investment and financial planning services designed to help you build, protect, and grow your wealth with confidence.'} />
                </div>
...
export default ServicecardTheme3;
