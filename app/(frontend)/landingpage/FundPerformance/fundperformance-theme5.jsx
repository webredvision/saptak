...
export default function FundPerformanceTheme5() {
  ...
  return (
    <motion.section
      className="text-[var(--rv-black)] overflow-hidden px-4 bg-[var(--rv-bg-white)]"
      initial={{ opacity: 0, y: 40 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true, amount: 0.2 }}
      transition={{ duration: 0.6, ease: "easeOut" }}
    >
      <div className="max-w-7xl mx-auto main-section flex flex-col gap-5 md:gap-8-bottom flex flex-col gap-6 md:gap-10">
        <motion.div
        ...
        <div className="w-full flex flex-col gap-5">
            ...
            {tabOptions.map((tab) => {
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className={`border border-[var(--rv-primary)] p-4 rounded-md transition-all duration-200 ${
                    isActive
          ...
          <motion.div
            className="overflow-x-auto rounded bg-[var(--rv-bg-white)] whitespace-nowrap"
          ...
          >
            {loading ? (
              <p className="bg-[var(--rv-primary)] text-[var(--rv-white)] py-4 text-center">
                Loading funds...
              </p>
            ) : performanceData.length > 0 ? (
              <table className="min-w-full text-[var(--rv-black)]">
                <thead className="bg-[var(--rv-primary)] text-[var(--rv-white)] rounded">
                  <tr>
                ...
                >
                  {performanceData.slice(0, 5).map((fund, idx) => (
                    <motion.tr
                      ...
                      custom={idx}
                      whileHover={{
                        backgroundColor: "var(--rv-primary-light)",
                        transition: { duration: 0.15 },
                      }}
                      className="cursor-pointer border-b border-[#e0e0e0]"
