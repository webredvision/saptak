...
export default function FundPerformanceTheme2() {
  ...
  return (
    <section
      className="text-[var(--rv-white)] overflow-hidden p-2 md:p-4 bg-[var(--rv-bg-black)]"
    >
      <div className="max-w-7xl mx-auto main-section flex flex-col gap-5 md:gap-8">
        ...
        <div className="w-full flex flex-col gap-5">
          <div className="w-full flex justify-center">
            <motion.div
              layout
              className="w-full bg-[var(--rv-bg-secondary)] p-3 rounded-xl border border-[var(--rv-white-light)]"
            >
                ...
                {tabOptions.map((tab, index) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className="relative overflow-hidden w-full p-3  rounded-lg font-semibold text-[var(--rv-white)]  "
                    >
                      {isActive && (
                        <motion.div
                          layoutId="activeTabBg"
                          className="absolute inset-0 bg-[var(--rv-primary)] rounded-lg"
                          transition={{
                            type: "spring",
                            stiffness: 260,
                            damping: 28,
                    ...
                    ${isActive
                                ? "bg-[var(--rv-bg-black)] text-[var(--rv-white)]"
                                : "bg-[var(--rv-bg-white-light)] text-[var(--rv-white)]"
                              }
                  `}
                          >
                        ...
                        <span
                          className={`${isActive ? "text-[var(--rv-black)]" : "opacity-90"
                            }`}
                        >
                          {tab.label}
                        </span>
          ...
          <motion.div
            className="overflow-x-auto bg-[var(--rv-bg-secondary)] rounded-xl border border-[var(--rv-white-light)]  whitespace-nowrap"
          ...
          >
            {loading ? (
              ...
              <table className="min-w-full ">
                <thead className="bg-[var(--rv-bg-black)] rounded-xl border border-[var(--rv-white-light)]">
                  <tr>
                ...
                >
                  {performanceData.slice(0, 5).map((fund, idx) => (
                    <motion.tr
                      ...
                      className="cursor-pointer border-t p-3 border-[var(--rv-white-light)]"
