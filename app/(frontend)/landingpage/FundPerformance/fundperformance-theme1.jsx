...
export default function FundPerformanceTheme1() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto main-section flex flex-col gap-5 md:gap-8 flex flex-col gap-6 md:gap-10">
        <motion.div
