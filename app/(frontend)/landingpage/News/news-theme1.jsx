                    ...
                    {categories.map((tab) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-full font-medium transition-all duration-300 ${activeTab === tab
                                ...
                                : "bg-[var(--rv-bg-primary-light)] text-[var(--rv-text-primary)] hover:bg-[var(--rv-bg-primary)] hover:text-[var(--rv-white)]"
                                }`}
                        >
                            {tab === "ipo"
                                ? "IPO News"
                    ...
                    {!loading && Array.isArray(activeData) && activeData.length > 0 && (
                        <>
                            <motion.div
                                ...
                                className="lg:col-span-2 bg-[var(--rv-bg-white)] text-[var(--rv-black)] rounded-xl overflow-hidden flex flex-col"
                            >
                            ...
                            <div className="flex flex-col gap-5 lg:col-span-2">
                                {activeData.slice(1, 3).map((news, i) => (
                                    <motion.div
                                        key={news._id || news.id || i}
                                        initial={{ opacity: 0, y: 40 }}
                                        whileInView={{ opacity: 1, y: 0 }}
                                        transition={{ duration: 0.5, delay: i * 0.1 }}
                                        className="bg-[var(--rv-bg-white)] text-[var(--rv-black)] rounded-xl overflow-hidden flex flex-col md:flex-row items-center gap-3"
                                    >
