...
const GalleryTheme2 = ({ images = [], videos = [] }) => {
  ...
  return (
    <>
      ...
      <div className="bg-[var(--rv-bg-secondary)] px-4">
            ...
            {mainTabs.map((tab) => (
              <button
                ...
                className={`px-5 py-2 rounded-full sm:text-base font-medium transition-all duration-300 ${activeTab === tab
                  ? "bg-[var(--rv-bg-secondary-light)] text-[var(--rv-white)] shadow-md scale-105"
                  : "bg-[var(--rv-bg-secondary)] text-[var(--rv-text)]"
                  }`}
              >
                {tab}
              </button>
                ...
                <div className="flex flex-wrap gap-3 w-full">
                  {categories.map((cat) => (
                    <button
                      ...
                      className={`px-5 py-2 rounded-full font-medium border border-[var(--rv-bg-white-light)] transition-all duration-300 ${activeCategory === cat
                        ? "bg-[var(--rv-bg-primary)]  text-[var(--rv-white)] shadow-md"
                        : "bg-[var(--rv-bg-secondary-light)] text-[var(--rv-white)]"
                        }`}
                    >
                      {cat}
                    </button>
