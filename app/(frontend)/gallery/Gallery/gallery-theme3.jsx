...
const GalleryTheme3 = ({ images = [], videos = [] }) => {
            ...
            {mainTabs.map((tab) => (
              <button
                ...
                className={`px-5 py-2 rounded-full sm:text-base font-medium transition-all duration-300 ${activeTab === tab
                  ? "bg-[var(--rv-bg-secondary)] text-[var(--rv-white)] shadow-md scale-105"
                  : "bg-[var(--rv-bg-secondary-light)] text-[var(--rv-text)]"
                  }`}
              >
                {tab}
              </button>
