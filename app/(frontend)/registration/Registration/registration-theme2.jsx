...
import { FaArrowRight, FaMailBulk, FaSpinner, FaIdCard, } from 'react-icons/fa'
...
const RegistrationTheme2 = ({ roboUser, sitedata, login }) => {
    ...
    return (
        <div>
            ...
            <div className="px-4 bg-[var(--rv-bg-black)] text-[var(--rv-white)]">
                <div className="w-full max-w-7xl mx-auto items-center justify-center main-section grid grid-cols-1 lg:grid-cols-2 gap-5">
                    {isVerified ? (
                        <SoftwareRegistration roboUser={roboUser} sitedata={sitedata} login={login} dark={true} />
                    ) : (
                        <div className="h-full bg-[var(--rv-bg-secondary)] rounded-xl p-4 md:p-6 flex flex-col justify-center w-full border border-[var(--rv-white-light)]">
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                <div className="w-full flex flex-col gap-6">
                                    <Heading align='start' title={'Welcome Back'} heading={'Software Registration'} highlight={'Registration'} description={'Enter your credentials to access your account'} />
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <p className="text-center">
                                            Already registered?{" "}
                                            <a href="/login" className="text-[var(--rv-primary)] font-semibold">
                                                Login here
                                            </a>
                                        </p>
                                    </div>
...
export default RegistrationTheme2
