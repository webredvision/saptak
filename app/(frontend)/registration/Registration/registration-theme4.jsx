...
// import { FaArrowRight, FaIdCard, FaMailBulk, FaSpinner } from 'react-icons/fa'
...
// const RegistrationTheme4 = ({ roboUser, sitedata, login }) => {
...
//             <div className="px-4 bg-[var(--rv-bg-white)] text-[var(--rv-white)]">
//                 <div className="w-full max-w-7xl mx-auto items-center justify-center main-section grid grid-cols-1 lg:grid-cols-6 gap-8">
...
//                     </div>
//                     <div className="lg:col-span-3 bg-gradient-to-tl from-[var(--rv-bg-primary)] via-[var(--rv-bg-secondary)] to-[var(--rv-bg-secondary)] h-full rounded-xl overflow-hidden p-4 md:p-6 flex flex-col justify-center w-full max-w-lg border border-[var(--rv-border)] relative z-10 ">
//                         {isVerified ? (
//                             <SoftwareRegistration roboUser={roboUser} sitedata={sitedata} login={login} dark={true} />
//                         ) : (
//                             <div className="w-full flex flex-col gap-6">
//                                 <Heading align='start' variant='light' title={'Welcome Back'} heading={'Software Registration'} description={'Enter your credentials to access your account'} />
...
//                                         <p className="text-center flex items-center gap-2 flex-wrap">
//                                             Already registered? {" "}
...
// export default RegistrationTheme4
