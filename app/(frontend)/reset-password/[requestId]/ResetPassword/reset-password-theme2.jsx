...
const Layout = ({ children }) => (
    <>
        ...
        <div className="relative flex justify-center items-center bg-[var(--rv-bg-black)] text-[var(--rv-white)] px-4">
...
export default function ResetPasswordTheme2({ status, requestId }) {
    ...
    if (status === "invalid") {
        return (
            <Layout>
                <div className="w-full max-w-md border border-white/20 rounded-xl p-6 text-center flex items-center flex-col gap-4">
    ...
    return (
        <>
            <ToastContainer />
            <Layout>
                <div className="w-full max-w-md border border-white/20 rounded-xl p-6 flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3 rounded-xl border  border-white/20 bg-transparent outline-none"
                            />
                            <button
                                type="button"
