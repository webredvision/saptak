...
const PrivacyPolicyTheme5 = ({ sitedata, privacyData }) => {
  ...
  const createMarkup = () => {
    ...
    let updatedHTML = privacyData
      .replace(
        ...
        `<mark style="background-color: var(--rv-primary); font-size: 16px; font-weight: 500;">${
      ...
      <section className="px-4">
        <div className=" max-w-7xl mx-auto main-section flex flex-col gap-6 md:gap-8">
          ...
          {!privacyData ? (
            ...
            <div
              className="prose max-w-none text-[var(--rv-gray-dark)] leading-relaxed"
...
export default PrivacyPolicyTheme5;
