...
const signinTheme2 = () => {
  ...
  return (
    <>
      ...
      <div className="relative flex justify-center items-center bg-[var(--rv-bg-black)] text-[var(--rv-white)] overflow-hidden px-4 pt-10">
        ...
        {showForgotModal && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-50 p-4 animate-fadeIn">
            <div className="relative w-full max-w-md bg-[var(--rv-bg-black)] border border-white/20 backdrop-blur-xl p-6 rounded-xl shadow-2xl animate-scaleIn">
              <button
