...
const FooterTheme4 = ({ services, sitedata, socialMedia, arnData }) => {
  const arn = arnData;
  ...
  return (
    <footer className="text-[var(--rv-white)] px-4 py-6 pt-10 relative z-10 bg-gradient-to-tl from-[var(--rv-bg-secondary)] via-[var(--rv-bg-secondary)] to-[var(--rv-bg-primary)] overflow-hidden">
