...
const FooterTheme3 = ({ services, sitedata, socialMedia, arnData }) => {
  const arn = arnData;
  ...
  return (
    <footer className="bg-[var(--rv-bg-primary)] text-[var(--rv-white)] px-4 py-6 pt-10 relative z-10 before:content-[''] before:absolute before:inset-0 before:bg-[url('/images/pricing-bg-image.png')] before:bg-cover before:bg-center before:-z-10">
      <div className="mx-auto w-full  max-w-7xl flex flex-col gap-5 ">
              ...
              {services.map((s, i) => (
                <li key={i} className="mb-3">
                  <Link
                    ...
                    className="duration-300 transition-all hover:text-[var(--rv-secondary)]"
                  >
                    {s.name}
                  </Link>
                </li>
        ...
        <div className="text-center flex flex-col gap-3 items-center">
          ...
          <p className="">
            ...
            platform of {sitedata?.websiteName}. It accepts no
