...
const FooterTheme5 = ({ services, sitedata, socialMedia, arnData }) => {
  const arn = arnData;
  ...
  return (
    <footer className="bg-[var(--rv-bg-secondary)] text-[var(--rv-white)] px-4 py-6 pt-10 relative z-10 overflow-hidden">
