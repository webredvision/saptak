...
const FooterTheme2 = ({ services, sitedata, socialMedia, arnData }) => {
  const arn = arnData;
  ...
  return (
    <footer className="bg-[var(--rv-bg-black)] text-[var(--rv-white)] px-4 py-6 pt-10 relative z-10 before:content-[''] before:absolute before:inset-0 before:bg-[url('/images/vector1.webp')] before:bg-cover before:bg-center before:-z-10">
              ...
              {services.map((s, i) => (
                <li key={i} className="mb-3">
                  <Link
                    ...
                    className="duration-300 transition-all hover:text-[var(--rv-primary)]"
                  >
                    {s.name}
                  </Link>
                </li>
